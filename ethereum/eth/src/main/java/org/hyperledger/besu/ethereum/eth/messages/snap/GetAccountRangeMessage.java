...
public final class GetAccountRangeMessage extends AbstractSnapMessageData {
  ...
  public GetAccountRangeMessage(final Bytes data) {
    super(data);
    RLPInput toRead = new BytesValueRLPInput(data, false);
    toRead.enterList();
    super.setRootHash(Optional.of(Hash.wrap(toRead.readBytes32())));
  }
  ...
  public static GetAccountRangeMessage create(
    ...
    tmp.writeBigIntegerScalar(responseBytesLimit);
    tmp.endList();
